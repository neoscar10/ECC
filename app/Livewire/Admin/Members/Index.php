...
class Index extends Component
{
    ...
    // --- Update Tier Logic (Moved to UpdateTierModal Component) ---
    // Methods removed: openUpdateTierModal, closeUpdateTierModal, updateTier, getDowngradeWarningProperty, getUpgradeInfoProperty
