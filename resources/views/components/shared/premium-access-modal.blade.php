@if($showAccessModal && $modalData)
  <div class="modal fade show" id="premiumAccessModal" tabindex="-1" style="display: block; background: rgba(0,0,0,0.85); backdrop-filter: blur(8px);" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered" style="max-width: 460px;">
      <div class="modal-content" style="background: #0d0c07; border: 1px solid rgba(212, 175, 55, 0.3); border-radius: 16px; box-shadow: 0 20px 50px rgba(0,0,0,0.8);">
        <div class="modal-body p-4 p-md-5 position-relative text-center">
          ...
          {{-- Icon --}}
          <div class="ecc-lock-icon mx-auto mb-4" style="width: 64px; height: 64px; background: rgba(212, 175, 55, 0.1); border: 1px solid rgba(212, 175, 55, 0.4); display: flex; align-items: center; justify-content: center; border-radius: 50%;">
            <span class="material-symbols-outlined" style="color: #D4AF37; font-size: 32px;">
          ...
          {{-- Title --}}
          <h3 class="mb-2" style="color: #fceec5; font-weight: 800; letter-spacing: -0.01em;">Unlock Premium Access</h3>
          <p style="color: #cbbc90; font-size: 14px; margin-bottom: 30px;">
            ...
            <div class="row text-start mt-2">
              ...
              <div class="{{ $colClass }}">
                ...
                @if(!empty($modalData['privileges']))
                  <div>
                    <h5 style="color: #fceec5; font-size: 13px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 12px;">Privileges</h5>
                    <ul class="list-unstyled m-0" style="color: #cbbc90; font-size: 13px;">
                      @foreach(array_slice($modalData['privileges'], 0, 5) as $privilege)
                        <li class="d-flex align-items-start mb-2">
                          <span class="material-symbols-outlined me-2 mt-1" style="color: #D4AF37; font-size: 16px; flex-shrink: 0;">check_circle</span>
              ...
              <div class="col-6">
                {{-- Premium Features --}}
                <div class="mb-3">
                  <h5 style="color: #fceec5; font-size: 13px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 12px;">Key Features</h5>
                  <ul class="list-unstyled m-0" style="color: #cbbc90; font-size: 13px;">
                    @foreach(array_slice($modalData['features'], 0, 5) as $feature)
                      <li class="d-flex align-items-start mb-2">
                        <span class="material-symbols-outlined me-2 mt-1" style="color: #D4AF37; font-size: 16px; flex-shrink: 0;">star</span>
