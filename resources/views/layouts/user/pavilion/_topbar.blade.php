<nav class="pavilion-topbar">
    <div class="pavilion-container px-3 d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center gap-2">
            <span class="material-symbols-outlined ecc-text-primary" style="font-size: 28px;">stadium</span>
            <span class="ecc-outfit fw-bold ecc-text-primary fs-5" style="letter-spacing: 0.5px;">The Pavilion</span>
        </div>
