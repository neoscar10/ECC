<div>
            ...
            <div class="col-lg-12">
                <div class="card" id="auctionList">
                    ...
                    <div class="card-body border border-dashed border-end-0 border-start-0">
                         @include('livewire.admin.auctions.partials._filters')
                    </div>

                    <div class="card-body">
                         @include('livewire.admin.auctions.partials._table')
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Modals -->
    @include('livewire.admin.auctions.partials._create-modal')
    ...
    <script>
        document.addEventListener('livewire:initialized', () => {
            ...
            Livewire.on('auction-created', () => { createModal.hide(); });
            Livewire.on('auction-updated', () => { createModal.hide(); });
        });
    </script>
</div>
