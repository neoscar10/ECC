<div class="row g-4">
    ...
    <div class="col-lg-6">
        ...
        <div class="card bg-light border p-3 h-100">
            <div class="mb-3">
                <p class="text-muted small">Visibility controls who can access this auction lot at all. Users who do not meet these criteria will not see the item.</p>
            </div>
            ...
            @else
                 <div class="alert alert-info border-0 mb-3">
                    <i class="ri-information-line me-1"></i> Public: Lot is visible to all active membership tiers.
                 </div>
            @endif
        </div>
    </div>
    ...
    <div class="col-lg-6">
        ...
        <div class="card bg-light border p-3 h-100">
             <div class="mb-3">
                <p class="text-muted small">Among users who can access the lot, select which tiers see it clearly. Others will see a blurred preview.</p>
            </div>
