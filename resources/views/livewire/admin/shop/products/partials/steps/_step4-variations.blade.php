...
@if(empty($variationGroups))
    <div class="text-center p-5 border-dashed rounded bg-light">
        ...
        <p class="text-muted mt-2">No variations added. This will be a simple product.</p>
        <button type="button" class="btn btn-sm btn-primary" wire:click="addVariationGroup">Add Options (Size, Color, etc.)</button>
    </div>
@else
